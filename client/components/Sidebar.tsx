...
function SidebarContent({
  username, userCount, photos, filter, onFilterChange, onLeave, onClose,
}: Omit<Props, 'eventId' | 'open'>) {
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto" style={{ color: 'rgba(255,255,255,.85)' }}>
      ...
      <div className="px-5 py-4 mt-auto" style={{ borderTop: '1px solid rgba(255,255,255,.08)' }}>
        ...
        <button
          onClick={onLeave}
          className="mt-4 w-full py-3 rounded-xl text-sm font-bold border flex items-center justify-center gap-2"
